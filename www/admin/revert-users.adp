...
<p>
Reverting all users to the default template will change every user's portal.  It also is extremly intensive computationally and may take a long time.
<p>
Do you really wish to continue?

<form name="op_revert" method=post action=revert-users-2>
