...
<multiple name=users_portals>
    ...
    Goto portal <b><a href="show-portal.tcl?portal_id=@users_portals.portal_id@">@users_portals.name@</a></b> (<b><a href="element-layout.tcl?portal_id=@users_portals.portal_id@">edit</a></b>|<b><a href="portal-delete.tcl?portal_id=@users_portals.portal_id@">delete</a></b>)
    </if>
    <br>
</multiple>
