...
ad_proc -private get_site_nodes_list {
} {
...
ad_proc -private get_site_nodes_list_key {
...
ad_proc -private get_site_nodes_list_value {
    {-site_nodes_list:required}
    {-index:required}
} {
...
ad_proc -private get_site_nodes_list_value_param {
    {-site_nodes_list:required}
    {-index:required}
    {-param:required}
} {
